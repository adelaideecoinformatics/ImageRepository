...
setup(
    ...
    install_requires=['xmltodict','PyYAML', 'python-dateutil', 'Flask', 'Flask-RESTful', 'marshmallow', 'python-swiftclient','wand', 'python-keystoneclient'],
...
#    data_files=[('my_data', ['data/data_file'])],
    ...
    entry_points={
        'console_scripts': [
            'image_repo = image_repo.Restful:startup',
        ],
    },
)
